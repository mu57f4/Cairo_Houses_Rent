...
## Model Selection
I trained 4 diffrenet ML algorithms with fixed parameters (not tuned), the models are:
- Linear Regression
- Random Forest
- XGBoost
- Support Vector Regressor (SVR)

Split the data into train and test sets and used cross-validation to detect overfitting/underfitting or failing to generalize patterns in the data.
...
### Conclusion
- Obviously, the best model score is Random Forest with almost 0.63 score.
